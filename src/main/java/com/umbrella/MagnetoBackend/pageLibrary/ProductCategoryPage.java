package com.umbrella.MagnetoBackend.pageLibrary;
...
import com.umbrella.MagnetoBackend.generics.DropDownHelper;
import com.umbrella.MagnetoBackend.generics.JavaScriptHelper;
import com.umbrella.MagnetoBackend.generics.LoggerHelper;
import com.umbrella.MagnetoBackend.generics.VerificationHelper;
...
public class ProductCategoryPage {
	...
	public List<WebElement> getAllProductsPrice(){
		System.out.println("****************************** I am Starting verifyLowestFirstPriceListInProduct_deatilsPage Test and current Thread***********************************"+Thread.currentThread().getId());
